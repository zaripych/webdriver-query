...
type QueryForResultType1<R, TConf extends IQueryConfig> = EqualTypes<R, boolean> extends YES
  ? ConditionQuery
  ...
  : (R extends object // <-- since ObjectQuery<R extends object>
      ? (Exclude<R, TConf['element'] | TConf['elementPromise']> extends never // <-- since these extends object
          ? AnyQuery
          : (EqualTypes<R, object> extends YES ? ObjectQuery<R> : never))
      : AnyQuery)

type QueryForResultType2<R, TConf extends IQueryConfig> = Extract<R, string> extends never // conflicts with Array
  ? R extends Array<infer Rr>
    ? ArrayQuery<Rr, QueryForResultType1<Rr, TConf>>
    : QueryForResultType1<R, TConf>
  : QueryForResultType1<R, TConf>

type QueryForResultType3<R, TConf extends IQueryConfig> = Extract<R, string> extends never
  ? R extends Array<infer Rr>
    ? ArrayQuery<Rr, QueryForResultType2<Rr, TConf>>
    : QueryForResultType1<R, TConf>
  : QueryForResultType1<R, TConf>

type QueryForResultType4<R, TConf extends IQueryConfig> = Extract<R, string> extends never
  ? R extends Array<infer Rr>
    ? ArrayQuery<Rr, QueryForResultType3<Rr, TConf>>
    : QueryForResultType1<R, TConf>
  : QueryForResultType1<R, TConf>

type QueryForResultType5<R, TConf extends IQueryConfig> = Extract<R, string> extends never
  ? R extends Array<infer Rr>
...
export type QueryForResultType<R, TConf extends IQueryConfig = IQueryConfig> = QueryForResultType5<
  R,
  TConf
>
