...
> extends PromiseLikeQueryNoExecute<TElement, TElementPromise> implements IElementQuery {
  ...
  public imitateAppendText(text: string): ElementQuery<TElement, TElementPromise> {
  ...
  public getSelectedOptions(): ArrayQuery<ISelectedOption, ObjectQuery<ISelectedOption>> {
    ...
    return new ArrayQuery(this.build(query), block => new ObjectQuery<ISelectedOption>(block))
  }
  ...
  private appendCall(method: keyof IElementQuery, ...args: Array<{}>): QueryBuilder {
