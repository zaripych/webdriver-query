...
export class NumberQuery extends PromiseLikeQuery<number>
  implements INumberQuery {
  ...
  public greaterThan(value: number): ConditionQuery {
    return new ConditionQuery(
      this.build(this.appendCall('greaterThan', value))
    );
  }
  ...
  public greaterThanOrEqual(value: number): ConditionQuery {
    return new ConditionQuery(
      this.build(this.appendCall('greaterThanOrEqual', value))
    );
  }

  public lessThanOrEqual(value: number): ConditionQuery {
    return new ConditionQuery(
      this.build(this.appendCall('lessThanOrEqual', value))
    );
  }
