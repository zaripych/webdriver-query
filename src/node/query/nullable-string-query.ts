import { ConditionQuery, StringQuery, PromiseLikeQuery, NumberQuery } from '../query'
import { INullableStringQuery, INumberConversionOptions } from '../../shared/query'
...
export class NullableStringQuery extends PromiseLikeQuery<string | null>
  ...
  public whenRejected(value: string): NullableStringQuery {
    return new NullableStringQuery(this.build(this.appendCall('whenRejected', value)))
  }
  ...
  private appendCall(name: keyof INullableStringQuery, ...args: Array<{} | null>) {
