...
export const isSeleniumLocator = (locator: any): locator is selenium.By => {
  return typeof locator === 'object' && 'using' in locator && 'value' in locator
}

export const locatorToSelector = (locator: selenium.By): string => {
  if (typeof locator !== 'object' || !('using' in locator) || !('value' in locator)) {
    throw new ArgumentError(`Expected 'using' and 'value' fields to exist in locator to convert it`)
  }
